...
<div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
        ...
        class="text-decoration-none">{{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}</p>
      <p class="card-text">{{ $posts[0]->excerpt }}</small>
    </p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    ...
                    class="text-decoration-none">{{ $post->author->name }}</a> {{ $post->created_at->diffForHumans() }}</p>
                  <p class="card-text">{{ $post->excerpt }}</small>
                </p>
